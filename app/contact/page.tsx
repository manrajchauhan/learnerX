    ...
    <div className="flex overflow-hidden flex-col justify-center px-10 pt-28 pb-20 max-md:px-5 max-md:pt-24">
      ...
      <div className="flex flex-wrap gap-10 items-start self-center mt-28 max-md:mt-10 max-md:max-w-full">
        <form className="flex flex-col justify-center min-w-[240px] w-[381px]">
          <div className="text-5xl font-medium leading-tight text-black">
            Message Us
          </div>
          <div className="flex flex-col mt-4 w-full text-sm font-semibold leading-6 whitespace-nowrap max-w-[381px]">
            ...
            <input type="text" className="flex items-end py-2 pr-2 pl-4 w-full bg-white rounded-md border-2 border-solid border-neutral-900" placeholder='Name' name='name'>
            </input>
          </div>
          <div className="flex flex-col mt-4 w-full text-sm font-semibold leading-6 whitespace-nowrap max-w-[381px]">
            <div className="flex overflow-hidden items-center self-start">
            ...
            <input type="email" className="flex items-end py-2 pr-2 pl-4 w-full bg-white rounded-md border-2 border-solid border-neutral-900" placeholder='Email' name='email'>
            </input>
          </div>
          <div className="flex flex-col mt-4 w-full max-w-[381px]">
            ...
            <input type="text" className="flex items-end py-2 pr-2 pl-4 w-full bg-white rounded-md border-2 border-solid border-neutral-900" placeholder='Message' name='message'>
            </input>
          </div>
        ...
        <div className="shrink-0 self-stretch w-0 bg-neutral-900 border-neutral-900 h-[393px]" />
        <div className="flex flex-col min-w-[351px] w-[351px]">
          <div className="text-5xl font-medium leading-tight text-black">
            Get in touch
          </div>
          <div className="flex overflow-hidden gap-4 items-center px-4 py-3 mt-6 w-full rounded-md border-2 border-solid border-neutral-900">
